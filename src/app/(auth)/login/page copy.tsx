...
export default function LoginCopy() {
  ...
  const onSubmit: SubmitHandler<IFormInputs> = (data: FormEvent) => {
  ...
  return (
    <AuthLayout title="Sign In to Your Account">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4">
        <FormInputIcon label="Email" name="email" type="email" placeholder="Enter your email address" {...register("email")}>
